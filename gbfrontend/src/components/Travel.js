            ...
            <main className="mx-auto max-w-[1080px]">
                <section className='sm:flex-row p-0 mt-6 sm:mt-16 items-center mb-12'>
                    ...
                    <article className='col-span-full mx-2 sm:mx-[10%] bg-gradient-to-r mt-20 py-10 from-white/70 via-white to-white/70 backdrop-saturate-[0.60] rounded-xl border-8 border-double border-slate-600/70 shadow-lg shadow-emerald-800'>
                        ...
                        <h3 className="flex flex-row justify-center text-2xl sm:text-3xl mt-10 font-bold text-left font-serif text-slate-600">Directions</h3>
                        <h4 className="text-xl px-[20%] sm:text-2xl mt-2 text-left text-slate-600">Beginning at The Water Tower Inn</h4>
                        <ol className="px-[20%] list-decimal">
                            <li className="text-lg sm:text-xl mt-2 text-left text-slate-600">
                                Head North on Highway 17 towards Wawa ON. for 30km 
                            </li>
                            <li className="text-lg sm:text-xl mt-2 text-left text-slate-600">
                                Turn right on Mahler Road
                            </li>
                            <li className="text-lg sm:text-xl mt-2 text-left text-slate-600">
                                Turn left on to Old Highway 17 Road (just past Mountain View Elementary School)
                            </li>
                            <li className="text-lg sm:text-xl mt-2 text-left text-slate-600">
                                At the Y intersection, bear right to stay on Ols Hwy 17 Rd. 
                            </li>
                            <li className="text-lg sm:text-xl mt-2 text-left text-slate-600">
                                Look for the Stokely Creek Lodge sign and turn right on to Pickard Road. You will enter the main parking lot shortly down this road.
                            </li>
                        </ol>
                        <h4 className="text-xl px-[20%] sm:text-2xl mt-6 text-left text-slate-600">
                            Please park in the main lot unless you have made arrangements ahead of time for accessibility. Stokely will have porters
                            to help transport everyone to the main lodge and to help bring belongings to your accommodations for those staying overnight.
                        </h4>
                    </article>
                    ...
                    <article className='mx-2 sm:mx-[10%] px-[10%] bg-gradient-to-r mt-20 py-10 from-white/70 via-white to-white/70 backdrop-saturate-[0.60] rounded-xl border-8 border-double border-slate-600/70 shadow-lg shadow-emerald-800'>
                        <h2 className="text-2xl flex flex-row justify-center sm:text-3xl mt-4 font-bold text-left font-serif text-slate-600">Bus Ride</h2>
                        <p className='text-base sm:text-xl mt-6 text-left text-slate-600'>
                            We have scheduled a bus to transport guests from town out to Stokely and two return trips through the night. The bus to the venue will be waiting at the Cambrian Mall near the Propane Depot for guests and will depart at 14:45 sharp. 
                            Please try to arrive by 14:30. There will be two return trips to town at 23:00 and 01:15. Let the bus driver know your address and they will bring you to your neighbourhood. Unfortunately, the bus will not be able to bring people to their exact address. 
                        </p>              
                    </article>

                    <article className='mx-2 sm:mx-[10%] px-[10%] bg-gradient-to-r mt-20 py-10 from-white/70 via-white to-white/70 backdrop-saturate-[0.60] rounded-xl border-8 border-double border-slate-600/70 shadow-lg shadow-emerald-800'>
                        <h2 className="text-2xl flex flex-row justify-center sm:text-3xl mt-4 font-bold text-left font-serif text-slate-600">Accommodations</h2>
                        <p className='text-base sm:text-xl mt-6 text-left text-slate-600'>
